...
<Project>
  ...
  <Grid ShowGridLines="True" ColumnSpacing="8" RowSpacing="8">
    ...
    <TextButton Text="Long Button" Grid.Column="1" />
    <TextButton Text="Very Long Button" Grid.Row="1" Grid.ColumnSpan="2" />
  </Grid>
</Project>
```
...
<Project>
  ...
  <Grid ShowGridLines="True" ColumnSpacing="8" RowSpacing="8">
    ...
    <TextButton Text="Button" />
    <TextButton Text="Long Button" Width="150" Grid.Column="1" />
    <TextButton Text="Very Long Button" Left="-10" Top="-10" HorizontalAlignment="Right" VerticalAlignment="Bottom" Grid.Row="1" Grid.ColumnSpan="2" />
    <TextButton Text="The Longest Button" HorizontalAlignment="Center" VerticalAlignment="Center" Grid.Column="2" Grid.Row="1" />
  </Grid>
</Project>
```
It would result in following:
